    ...
    public Integer addProduct(Integer productId, Integer quantity, Customer customer)
        ...
        if (cartItem != null) {
            ...
            if (updatedQuantity > 5) {
                throw new ShoppingCartException("Không thể thêm " + quantity + " mặt hàng nữa vì đã có " +
                        cartItem.getQuantity() + " mặt hàng trong giỏ hàng của bạn. Số lượng tối đa cho phép là 5.");
            }
        } else {
